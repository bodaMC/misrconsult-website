...
export default function ClientsPage() {
  return (
    <>
      <section className="relative flex min-h-[30vh] items-end overflow-hidden bg-misr-950">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-6 pb-20 pt-16 lg:px-8 lg:pb-28 lg:pt-44">
          <Link
            href="/#clients"
