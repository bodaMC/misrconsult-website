...
export function ClientCard({ client, variant = "showcase" }: ClientCardProps) {
  return (
    <li className={variant === "grid" ? "min-w-0 w-full" : showcaseListClass}>
      <div className="group relative flex h-28 items-center justify-center border border-white/10 bg-white/[0.03] px-6 py-8 backdrop-blur-sm transition-all duration-500 hover:bg-white hover:shadow-lg hover:shadow-misr-gold/50 sm:h-32 lg:h-36">
