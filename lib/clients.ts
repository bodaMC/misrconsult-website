...
export const clients: Client[] = [
  ...
  { name: "Emaar",logo: "/clients/emaar.png", size: "max-w-[135px]"},
  ...
  { name: "Jubail", logo: "/clients/Jubail-Uni.png" }, 
  { name: "King Abdulaziz", logo: "/clients/king-abdulaziz-uni.png", size: "max-w-[73px]"  },
  { name: "Ministry-of-housing-Logo", logo: "/clients/Ministry-of-housing-Logo.png", size: "max-w-[83px]"  },
  { name: "AWQAF", logo: "/clients/AWQAF.png", size: "max-w-[133px]"  },
  { name: "EBB Yemen", logo: "/clients/ebb-yemen.png", size: "max-w-[95px]"  },
  { name: "KAUST logo", logo: "/clients/KAUST-logo.svg", size: "max-w-[145px]"  },
  { name: "Saud", logo: "/clients/Saud-Consult.png", size: "max-w-[100px]"  },
  { name: "University-of-Dammam", logo: "/clients/University-of-Dammam.png", size: "max-w-[140px]"  },
  { name: "SWA", logo: "/clients/swa-black.jpg", size: "max-w-[140px]"  },
  { name: "Saudi-Ministry-of-Justice-Logo", logo: "/clients/Saudi-Ministry-of-Justice-Logo.png", size: "max-w-[80px]"  },
  { name: "KFU", logo: "/clients/kfu-logo.png", size: "max-w-[150px]"  },
...
export const portfolioPdfUrl = "/documents/misr-consult-portfolio.pdf";
