...
export const clients: Client[] = [
  ...
  { name: "Ministry-of-housing-Logo", logo: "/clients/housing.png", size: "max-w-[83px]"  },
  ...
  { name: "Saudi-Ministry-of-Justice-Logo", logo: "/clients/Saudi-Ministry.png", size: "max-w-[80px]"  },
